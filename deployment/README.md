...
| Query-facing Dataverse shortcuts | **Create or reuse** | The bootstrap creates `Tables/dataverse/*` directly from the validated Dataverse target metadata. This works for both separate and co-located source layouts without a OneLake self-reference. |
